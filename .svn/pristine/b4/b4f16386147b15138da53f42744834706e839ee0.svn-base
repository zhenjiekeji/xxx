...
<rapid:override name="head">
    <title><%=SecSysSeqrule.TABLE_ALIAS%>编辑</title>
</rapid:override>
<rapid:override name="container">
	<div class="positionPanel">
		<em></em>当前位置>><%=SecSysSeqrule.TABLE_ALIAS%>编辑<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back"></a>
	</div>
	<div class="formPanel">
	<form action="${ctx}/framework/system/SecSysSeqrule/update.do" method="post">
