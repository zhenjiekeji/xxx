...
public class SecPrivilegeUserDMZ extends BaseEntity implements SecUserDetails, UserInfo<String> {
    ...
    public enum UserStateEnum {
        ...
        UserStateEnum(int status, String statusString) {
            this.status = status;
