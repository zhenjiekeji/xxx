...
<rapid:override name="head">
    <title><%=SecSysRulevalue.TABLE_ALIAS%>新增</title>
</rapid:override>
<rapid:override name="container">
	<div class="positionPanel">
		<em></em>当前位置>><%=SecSysRulevalue.TABLE_ALIAS%>新增<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back"></a>
	</div>
	<div class="formPanel">
		<form action="${ctx}/framework/system/SecSysRulevalue/save.do" method="post">
