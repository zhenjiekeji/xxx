...
<rapid:override name="head">
    <title><%=SecSysSeqrule.TABLE_ALIAS%>新增</title>
</rapid:override>
<rapid:override name="container">
	<div class="positionPanel">
		<em></em>当前位置>><%=SecSysSeqrule.TABLE_ALIAS%>新增<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back"></a>
	</div>
	<div class="formPanel">
		<form action="${ctx}/framework/system/SecSysSeqrule/save.do" method="post">
