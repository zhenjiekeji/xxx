...
<rapid:override name="head">
    <title><%=SecBasDicItem.TABLE_ALIAS%>新增</title>
...
<rapid:override name="container">
	<div class="positionPanel">
		<em></em>当前位置>><%=SecBasDicItem.TABLE_ALIAS%>新增<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back"></a>
	</div>
	<div class="formPanel">
		<form id="itemForm" action="${ctx}/framework/privilege/SecBasDicItem/save.do" method="post">
