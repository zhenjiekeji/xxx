...
<rapid:override name="head">
    <title><%=SecPrivilegeRole.TABLE_ALIAS%> 编辑</title>
...
<rapid:override name="container">
	...
	<div class="positionPanel">
		<em></em>当前位置>><%=SecPrivilegeRole.TABLE_ALIAS%> 编辑<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back"></a>
	</div>
	<div class="formPanel">
		<form id="roleForm" action="${ctx}/framework/privilege/SecPrivilegeRole/update.do" method="post">
			...
			<div class="formPanelBody">
				<table class="formTable" cellpadding="0" cellspacing="0">
					<tr>
					    <td class="tdLabel"><font class="red">*</font><%=SecPrivilegeRole.ALIAS_ROLE_NAME%>：</td>
					    <td>
					    	<input type="text" id="roleName" name="roleName" value="<s:property value='%{model.roleName}'/>"/>
					    </td>
				  	</tr>
				  	<tr>
					    <td class="tdLabel"><%=SecPrivilegeRole.ALIAS_ROLE_DESCRIPTION%>：</td>
					    <td>
					    	<textarea id="roleDescription" name="roleDescription" rows="8" cols="100"><s:property value="%{model.roleDescription}"/></textarea>
					    </td>
				  	</tr>
	    		</table>
	    	</div>
